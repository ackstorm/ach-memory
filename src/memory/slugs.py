...
def slug_from_locator(remote_url: str) -> str:
    """Derive a project slug from a Git remote (SPEC §8.2): host/path
    flattened, lowercased, with an 8-hex digest suffix so differently-
    segmented locators don't collapse to the same slug. Called by the proxy.
    """
