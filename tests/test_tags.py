...
from memory.tags import RESERVED_PREFIXES, basis_tag, normalize_caller_tags, type_tag


def test_builder_tags():
    assert type_tag("fact") == "type:fact"
    assert basis_tag("human_explicit") == "basis:human_explicit"
...
@pytest.mark.parametrize(
    "bad", [5, "repo:x", {"repo": "x"}, [1, 2], ["repo:x", 7], [None], [["repo:x"]]]
)
